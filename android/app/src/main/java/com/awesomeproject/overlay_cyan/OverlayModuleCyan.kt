...
class OverlayModuleCyan(private val reactContext: ReactApplicationContext) :
    ReactContextBaseJavaModule(reactContext) {

    override fun getName(): String = "OverlayCyan"
    ...
    fun showOverlay() {
        ...
        val intent = Intent(reactContext, OverlayServiceCyan::class.java)
    ...
    fun showOverlayWithBlink(onDuration: Int, offDuration: Int) {
        ...
        val intent = Intent(reactContext, OverlayServiceCyan::class.java).apply {
